...
const LegalSection: React.FC<LegalSectionProps> = ({ activeTab }) => {
  ...
  const renderLegalNotice = () => (
    <div className="space-y-6 text-gray-600">
      <h2 className="text-3xl font-bold text-black mb-8">AVISO LEGAL</h2>
      
      <h3 className="text-xl font-bold text-black mt-6">1. Datos Identificativos</h3>
      <p>
      ...
      <h3 className="text-xl font-bold text-black mt-6">2. Usuarios</h3>
      <p>
      ...
      <h3 className="text-xl font-bold text-black mt-6">3. Propiedade Intelectual e Industrial</h3>
      <p>
      ...
      <h3 className="text-xl font-bold text-black mt-6">4. Exclusión de Garantías e Responsabilidade</h3>
      <p>
  ...
  const renderPrivacyPolicy = () => (
    <div className="space-y-6 text-gray-600">
      <h2 className="text-3xl font-bold text-black mb-8">POLÍTICA DE PRIVACIDADE</h2>
      ...
      <h3 className="text-xl font-bold text-black mt-6">1. Responsable do Tratamento</h3>
      <p>
      ...
      <h3 className="text-xl font-bold text-black mt-6">2. Finalidade do Tratamento</h3>
      <p>
      ...
      <h3 className="text-xl font-bold text-black mt-6">3. Lexitimación</h3>
      <p>
      ...
      <h3 className="text-xl font-bold text-black mt-6">4. Destinatarios</h3>
      <p>
        Os datos non se comunicarán a terceiros, agás por obriga legal.
      </p>

      <h3 className="text-xl font-bold text-black mt-6">5. Dereitos</h3>
      <p>
  ...
  const renderCookiesPolicy = () => (
    <div className="space-y-6 text-gray-600">
      <h2 className="text-3xl font-bold text-black mb-8">POLÍTICA DE COOKIES</h2>
      ...
      <h3 className="text-xl font-bold text-black mt-6">Que son as Cookies?</h3>
      <p>
      ...
      <h3 className="text-xl font-bold text-black mt-6">Cookies que utiliza esta web</h3>
      <ul className="list-disc list-inside ml-4 space-y-2">
      ...
      <h3 className="text-xl font-bold text-black mt-6">Como desactivar as cookies?</h3>
      <p>
  ...
  return (
    <div className="max-w-4xl mx-auto py-12 animate-in fade-in duration-500">
      <div className="bg-white p-8 md:p-12 rounded-sm border border-gray-200 shadow-xl">
