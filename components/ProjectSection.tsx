...
const ProjectSection: React.FC<ProjectSectionProps> = ({ onSubmit }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto text-black">
        ...
        {!isSubmitted ? (
            <form onSubmit={handleSubmit} className="bg-white p-8 md:p-12 rounded-sm border border-gray-200 space-y-8 shadow-2xl">
                {/* Personal Info */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label className="block text-xs uppercase tracking-widest text-gray-500 mb-2">Nome e Apelidos *</label>
                        <input type="text" name="name" required value={formData.name} onChange={handleChange} className="w-full bg-white border border-gray-200 text-black p-3 focus:border-[#4a5d23] focus:outline-none transition-colors" />
                    </div>
                    <div>
                        <label className="block text-xs uppercase tracking-widest text-gray-500 mb-2">E-mail *</label>
                        <input type="email" name="email" required value={formData.email} onChange={handleChange} className="w-full bg-white border border-gray-200 text-black p-3 focus:border-[#4a5d23] focus:outline-none transition-colors" />
                    </div>
                    <div>
                        <label className="block text-xs uppercase tracking-widest text-gray-500 mb-2">Teléfono *</label>
                        <input type="tel" name="phone" required value={formData.phone} onChange={handleChange} className="w-full bg-white border border-gray-200 text-black p-3 focus:border-[#4a5d23] focus:outline-none transition-colors" />
                    </div>
                    <div>
                        <label className="block text-xs uppercase tracking-widest text-gray-500 mb-2">Redes Sociais do Proxecto</label>
                        <input type="text" name="socials" value={formData.socials} onChange={handleChange} placeholder="@instagram, web..." className="w-full bg-white border border-gray-200 text-black p-3 focus:border-[#4a5d23] focus:outline-none transition-colors" />
                    </div>
                </div>
                ...
                <div className="border-t border-gray-200 pt-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                         <div className="md:col-span-2">
                            ...
                            <input type="text" name="title" required value={formData.title} onChange={handleChange} className="w-full bg-white border border-gray-200 text-black p-3 focus:border-[#4a5d23] focus:outline-none transition-colors" />
                        </div>
                        <div className="md:col-span-2">
                            <label className="block text-xs uppercase tracking-widest text-gray-500 mb-2">En que disciplina se enmarca? *</label>
                            <select name="discipline" required value={formData.discipline} onChange={handleChange} className="w-full bg-white border border-gray-200 text-black p-3 focus:border-[#4a5d23] focus:outline-none transition-colors">
                    ...
                    <div className="mb-6">
                        ...
                        <textarea name="description" required rows={6} value={formData.description} onChange={handleChange} className="w-full bg-white border border-gray-200 text-black p-3 focus:border-[#4a5d23] focus:outline-none transition-colors" />
                    </div>
                    ...
                    <div className="mb-6">
                        ...
                        <textarea name="bio" required rows={4} value={formData.bio} onChange={handleChange} className="w-full bg-white border border-gray-200 text-black p-3 focus:border-[#4a5d23] focus:outline-none transition-colors" />
                    </div>
                    ...
                    <div className="mb-6">
                        ...
                        <div className="relative">
                            <input 
                                ...
                                className="block w-full text-sm text-gray-500 file:mr-4 file:py-3 file:px-6 file:rounded-none file:border-0 file:text-xs file:font-semibold file:uppercase file:bg-[#4a5d23] file:text-white hover:file:bg-[#3a4a1b] bg-white border border-gray-200"
                            />
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-3 border-t border-gray-200 pt-6">
                    <input 
                        ...
                        className="w-5 h-5 accent-[#4a5d23] bg-white border-gray-300"
                    />
                    <label htmlFor="terms" className="text-sm text-gray-600">
                        Lin e acepto os <a href="#" className="underline hover:text-black">termos e condicións</a> para o envío de propostas. *
                    </label>
                </div>
             ...
             <div className="bg-white p-12 md:p-24 rounded-sm border border-gray-200 text-center animate-in fade-in duration-700 shadow-2xl">
